...
public class Rumbler {
	...
	public Rumbler(Joystick js) { this.js = js; }
	
	private void setRough(boolean on) { js.setRumble(RumbleType.kLeftRumble, on ? 1 : 0); }
	private void setSoft(boolean on) { js.setRumble(RumbleType.kRightRumble, on ? 1 : 0); }
